...
const App = () => {
  ...
  useEffect(() => {
    // Text Animation for all texts using staggered effect
      ...
      {images.map((src, index) => (
        ...
        >
          <div className="absolute inset-0 bg-white">
            ...
            {/* Big text across div2 and div3 */}
            {/* {(index === 2 || index === 3) && (
              <div ref={(el) => textRefs.current.push(el)} className="absolute top-4 left-4 font-normal text-black z-20 p-2">
                <p className='text-7xl text-center'>Where Form and Function Unite</p>
              </div>
            )} */}
